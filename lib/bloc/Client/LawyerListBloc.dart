...
class LawyerListBloc {
  ...
  StreamSink<APIResponse<LawyerListModel>> get lawyerListSink => lawyerListController.sink;
  ...
  getLawyerList(Map<String, dynamic> params) async {
    lawyerListSink.add(APIResponse.loading('Processing...'));
    try {
      LawyerListModel lawyerList = await lawyerListRepository.getLawyerList(params);
